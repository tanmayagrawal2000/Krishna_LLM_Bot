...
class Prompt(Enum):
    ...
    If you're referring to any verse of Bhagavad Gita by A. C. Bhaktivedanta Swami Prabhupada, enclose it within '<' and '>' and explain it as well.
    ...
    Use modern tone of language
    The answer should not be more than 4 sentences
    Give examples if needed to support your answer
    """